...
def starts_with_r(r_check_array)
  r_check_array.all? do |word|
    word[0].downcase == "r"
  end
end
...
def create_a_array(given_array)
  given_array.keep_if do |word|
    word.include? "a" 
  end
end
...
def begins_with_wa(given_array)
  given_array.each do |word|
    return word if word[0..1].downcase == "wa"
  end
end
...
def all_begins_with_wa(given_array)
  given_array.keep_if do |word|
    word[0..1].downcase == "wa"
  end
end
...
def keep_only_strings(given_array)
  given_array.keep_if do |word|
    word.class == String
  end
end
